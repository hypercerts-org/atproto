...
import * as permissionAuditLog from './permission-audit-log'
import * as refreshToken from './refresh-token'
import * as repoRoot from './repo-root'
import * as sharedRepositoryPermissions from './shared-repository-permissions'
...
export type DatabaseSchema = actor.PartialDB &
  ...
  sharedRepositoryPermissions.PartialDB &
  permissionAuditLog.PartialDB
...
export type { SharedRepositoryPermissions } from './shared-repository-permissions'
export type { PermissionAuditLog } from './permission-audit-log'
